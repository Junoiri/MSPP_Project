...
class EditUpcomingVaccinationActivity : AppCompatActivity() {
                ...
                CoroutineScope(Dispatchers.Main).launch {
                    try {
                        ...
                        userId?.let {
                            ...
                            updateScheduledVaccination(scheduleId, scheduledVaccination, applicationContext)
                        }
                    } catch (e: Exception) {
                        Toast.makeText(this@EditUpcomingVaccinationActivity, "Failed to get user ID", Toast.LENGTH_SHORT).show()
    ...
    private suspend fun updateScheduledVaccination(schedule_id: Int, scheduledVaccination: ScheduledVaccination, context: Context) {
        withContext(Dispatchers.IO) {
            val result = ScheduledVaccinationSF.updateScheduledVaccination(schedule_id, scheduledVaccination)
